...
class EventsViewModel(
    ...
    private val defaultDisparcher: CoroutineDispatcher) : ViewModel() {
   ...
   fun fetch() = viewModelScope.launch(defaultDisparcher) {
        safeFetch()
    ...
    private fun handleResponse(response: Response<EventsDto>):
            ResourceState<EventsDto> {
